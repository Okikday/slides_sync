...
export 'package:slides_sync/shared/styles/theme/themes.dart';
...
class AppColors {
  ...
  static Color bgBlendColor(
    ...
    return HSLColor.fromColor(
      bgColor,
    ).withLightness(isDarkMode ? (darkValue ?? 0.1) : (value ?? 0.9)).toColor();
  }

  static Color lightenColor(Color color, double value) =>
