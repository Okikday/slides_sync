...
void _courseContentSerialize(
  ...
  writer.writeByte(offsets[0], object.courseContentType.index);
...
CourseContent _courseContentDeserialize(
  ...
  final object = CourseContent(
    courseContentType: _CourseContentcourseContentTypeValueEnumMap[
...
extension CourseContentQueryFilter
  ...
  QueryBuilder<CourseContent, CourseContent, QAfterFilterCondition> idEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CourseContent, CourseContent, QAfterFilterCondition> idContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<CourseContent, CourseContent, QAfterFilterCondition> idMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
