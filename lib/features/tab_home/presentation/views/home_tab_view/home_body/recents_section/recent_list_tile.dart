...
class RecentListTile extends ConsumerWidget {
  ...
  Color _resolveLevelColor(ProgressLevel level) {
    return level == ProgressLevel.danger
        ? Colors.red
        : (level == ProgressLevel.warning ? Colors.orange : (level == ProgressLevel.success ? Colors.green : Colors.deepPurple));
  }
          ...
          children: [
            Badge(
              ...
              child: CustomElevatedButton(
                ...
                child: Icon(Iconsax.document_1, size: 26, color: context.isDarkMode ? context.theme.cardColor : context.theme.primaryColor,),
              ),
            ),
                  ...
                  children: [
                    Flexible(
                      child: ConstrainedBox(
                        ...
                        child: CustomText(dataModel.title, fontSize: 14, fontWeight: FontWeight.bold, height: 1.0),
                      ),
                    ),
                    Flexible(
                      child: CustomText(
                  ...
                  Positioned(
                    ...
                    child: IgnorePointer(
                      child: CircularProgressIndicator(
                        ...
                        color: _resolveLevelColor(dataModel.progressLevel),
