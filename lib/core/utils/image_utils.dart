...
class ImageUtils {
  ...
  Future<Result<File>> compressImage({
    ...
    try {
      ...
      final String outPath = await _generateNextFilePath(docDir, ext);
  ...
  CompressFormat _formatFromExt(String ext) {
    switch (ext) {
      case 'png':
  ...
  Future<String> _generateNextFilePath(Directory dir, String ext) async {
